            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 px-4 font-karla">
                ...
                <div className="px-2">
                    ...
                    <div className="flex flex-wrap items-center mt-4 mb-2">
                        <button
                            type="button"
                            className="flex space-x-1 items-center mr-2 mb-2 hover:bg-pint-700 text-white py-2 px-4 rounded bg-pink-500"
                            onClick={addCart}
                            title="ADD TO CART"
                        >
